	...
	FONTFACE="Courier"
	FONTSIZE="4"
	SCHEME="DarkRainBow" # Choose a key from set of scheme names in 'var options' below, or add a scheme
	...
	var	options = {'msg':'$CLEAN', 'fontface':'$FONTFACE','fontsize':$FONTSIZE},
		dctPalette = {
			'BlackToRed' : {'model':'hsl', 'percent':[false, true, true],
							p1:[0, 255], p2:[20, 100], p3:[20, 50], cycles:2},
			...
			'DarkRainBow' : {'model':'hsl', 'percent':[false, true, true],
							p1:[255,0], p2:[0, 100], p3:[50, 50], cycles:2},
